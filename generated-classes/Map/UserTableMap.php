...
class UserTableMap extends TableMap
{
     ...
     */
    const COL_CREATED_DATE = 'users.CREATED_DATE';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('UserId', 'UserName', 'CreatedDate', ),
        self::TYPE_STUDLYPHPNAME => array('userId', 'userName', 'createdDate', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_ID, UserTableMap::COL_USER_NAME, UserTableMap::COL_CREATED_DATE, ),
        self::TYPE_RAW_COLNAME   => array('COL_USER_ID', 'COL_USER_NAME', 'COL_CREATED_DATE', ),
        self::TYPE_FIELDNAME     => array('user_id', 'user_name', 'created_date', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('UserId' => 0, 'UserName' => 1, 'CreatedDate' => 2, ),
        self::TYPE_STUDLYPHPNAME => array('userId' => 0, 'userName' => 1, 'createdDate' => 2, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_ID => 0, UserTableMap::COL_USER_NAME => 1, UserTableMap::COL_CREATED_DATE => 2, ),
        self::TYPE_RAW_COLNAME   => array('COL_USER_ID' => 0, 'COL_USER_NAME' => 1, 'COL_CREATED_DATE' => 2, ),
        self::TYPE_FIELDNAME     => array('user_id' => 0, 'user_name' => 1, 'created_date' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('USER_NAME', 'UserName', 'VARCHAR', true, 20, null);
    ...
    {
        $this->addRelation('Comment', '\\Comment', RelationMap::ONE_TO_MANY, array('user_id' => 'user_id', ), 'CASCADE', null, 'Comments');
    } // buildRelations()
    /**
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserTableMap::COL_CREATED_DATE);
        } else {
