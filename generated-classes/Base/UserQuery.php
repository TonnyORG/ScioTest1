 ...
 * @method     ChildUserQuery orderByCreatedDate($order = Criteria::ASC) Order by the created_date column
 *
 ...
 * @method     ChildUserQuery groupByCreatedDate() Group by the created_date column
 *
 ...
 * @method     ChildUser findOneByCreatedDate(string $created_date) Return the first ChildUser filtered by the created_date column
 *
 ...
 * @method     ChildUser[]|ObjectCollection findByCreatedDate(string $created_date) Return ChildUser objects filtered by the created_date column
...
abstract class UserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'propel_scio1', $modelName = '\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT USER_ID, USER_NAME, CREATED_DATE FROM users WHERE USER_ID = :p0';
        try {
    ...
    public function filterByCreatedDate($createdDate = null, $comparison = null)
    {
        if (is_array($createdDate)) {
            ...
            if (isset($createdDate['min'])) {
                $this->addUsingAlias(UserTableMap::COL_CREATED_DATE, $createdDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdDate['max'])) {
                $this->addUsingAlias(UserTableMap::COL_CREATED_DATE, $createdDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserTableMap::COL_CREATED_DATE, $createdDate, $comparison);
    }
