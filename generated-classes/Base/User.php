...
abstract class User implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserTableMap::translateFieldName('CreatedDate', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function setCreatedDate($v)
    {
        ...
        if ($this->created_date !== null || $dt !== null) {
            if ($dt !== $this->created_date) {
                ...
                $this->modifiedColumns[UserTableMap::COL_CREATED_DATE] = true;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_CREATED_DATE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_CREATED_DATE)) {
            $criteria->add(UserTableMap::COL_CREATED_DATE, $this->created_date);
        }
