 ...
 * @method     ChildCommentQuery orderByComment($order = Criteria::ASC) Order by the comment column
 ...
 * @method     ChildCommentQuery groupByComment() Group by the comment column
 ...
 * @method     ChildComment findOneByComment(string $comment) Return the first ChildComment filtered by the comment column
 ...
 * @method     ChildComment[]|ObjectCollection findByComment(string $comment) Return ChildComment objects filtered by the comment column
...
abstract class CommentQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'propel_scio1', $modelName = '\\Comment', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT COMMENT_ID, USER_ID, COMMENT, CREATED_DATE FROM comments WHERE COMMENT_ID = :p0';
        try {
    ...
    public function filterByComment($comment = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CommentTableMap::COL_COMMENT, $comment, $comparison);
    }
